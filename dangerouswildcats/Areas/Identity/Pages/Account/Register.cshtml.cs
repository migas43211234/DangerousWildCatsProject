...
namespace dangerouswildcats.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            UserManager<dangerouswildcatsUser> userManager,
            SignInManager<dangerouswildcatsUser> signInManager,
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(100, ErrorMessage = "A password deve ter no minimo 6 caracteres e no máximo 100 caracteres.", MinimumLength = 6)]
            ...
            [Compare("Password", ErrorMessage = "A password e confirmação de password não combina!")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new dangerouswildcatsUser { UserName = Input.Name, Email = Input.Email, FirstName = Input.Name};
